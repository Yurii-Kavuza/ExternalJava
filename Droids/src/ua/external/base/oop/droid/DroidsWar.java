...
public class DroidsWar {
    public static void main(String[] args) {
        Droid houseWorker = new HouseworkerDroid(70,40,40, "Josh");
        System.out.println(houseWorker.getAlive());
        System.out.println(houseWorker);
        houseWorker.setDamageBehavior(new DamageWithoutWeapon(50));
        System.out.println(houseWorker);
        System.out.println(houseWorker.getAlive());
